...
//Fondo
PImage img, Hamb,hamb1, patricio1,letrero1, pantallainicio, pantallafinal,planktongg, almeja,ganaste;
...
vientop= minim.loadSample ("Viento.mp3",512);
...
/*for (int i = 0; i < images1.length; i++){
  images1[i] = loadImage("almeja_" + i + ".png");
}*/
...
estadoI=3;
 ...
 if (plankton.getY()>=630||plankton.getX()>=1080||plankton.getX()<-10) {
  ...
  if (segundos!=0) {              //segundos si es distinto a 0 
    ...
    text(segundos, posXT+40, posYT+38);
  }
